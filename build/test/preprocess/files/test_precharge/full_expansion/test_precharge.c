...
# 7 "test/test_precharge.c" 2

# 1 "build/test/mocks/test_precharge/mock_stm32g4xx_hal.h" 1
# 11 "build/test/mocks/test_precharge/mock_stm32g4xx_hal.h"
#pragma GCC diagnostic push
...
# 10 "test/test_precharge.c" 2
# 1 "Core/Inc/config.h" 1
# 11 "test/test_precharge.c" 2
...
void test_Precharge_Init(void)
{
 ...
 UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((prechargeDone)), (
# 44 "test/test_precharge.c" 3 4
((void *)0)
# 44 "test/test_precharge.c"
), (UNITY_UINT)(44), UNITY_DISPLAY_STYLE_UINT);
...
void test_Precharge_Start(void)
{
 ...
 UnityAssertEqualNumber((UNITY_INT)((1)), (UNITY_INT)((prechargeDone)), (
# 55 "test/test_precharge.c" 3 4
((void *)0)
# 55 "test/test_precharge.c"
), (UNITY_UINT)(55), UNITY_DISPLAY_STYLE_UINT);

 prechargeStart();

 UnityAssertEqualNumber((UNITY_INT)((1)), (UNITY_INT)((prechargeDone)), (
# 59 "test/test_precharge.c" 3 4
((void *)0)
# 59 "test/test_precharge.c"
