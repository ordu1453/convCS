# 0 "test/test_sensor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "test/test_sensor.c"
...
# 7 "test/test_sensor.c" 2

# 1 "build/test/mocks/test_sensor/mock_stm32g4xx_hal.h" 1
# 11 "build/test/mocks/test_sensor/mock_stm32g4xx_hal.h"
#pragma GCC diagnostic push
...
# 494 "build/test/mocks/test_sensor/mock_stm32g4xx_hal.h"
#pragma GCC diagnostic pop
# 9 "test/test_sensor.c" 2
# 1 "Core/Inc/diag.h" 1
# 15 "Core/Inc/diag.h"
...
# 10 "test/test_sensor.c" 2
# 1 "Core/Inc/config.h" 1
# 11 "test/test_sensor.c" 2
