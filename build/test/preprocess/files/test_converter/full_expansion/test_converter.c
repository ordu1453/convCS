# 0 "test/test_converter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "test/test_converter.c"
...
# 7 "test/test_converter.c" 2

# 1 "build/test/mocks/test_converter/mock_stm32g4xx_hal.h" 1
# 11 "build/test/mocks/test_converter/mock_stm32g4xx_hal.h"
#pragma GCC diagnostic push
...
# 494 "build/test/mocks/test_converter/mock_stm32g4xx_hal.h"
#pragma GCC diagnostic pop
# 9 "test/test_converter.c" 2
# 1 "Core/Inc/diag.h" 1
# 15 "Core/Inc/diag.h"
...
# 10 "test/test_converter.c" 2
# 1 "Core/Inc/config.h" 1
# 11 "test/test_converter.c" 2
...
# 167 "test/test_converter.c"
    ...
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((STATE_DISABLE)), (UNITY_INT)(UNITY_UINT32)((currentPWMState)), (
# 168 "test/test_converter.c" 3 4
   ((void *)0)
# 168 "test/test_converter.c"
